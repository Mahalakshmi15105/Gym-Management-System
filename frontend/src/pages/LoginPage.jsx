...
export default function LoginPage() {
  ...
  return (
    <div className="bg-slate-950 min-h-screen flex items-center justify-center relative overflow-hidden px-4">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-slate-400 mt-2 text-sm">Log in to manage your gym tenant workspace</p>
        </div>
